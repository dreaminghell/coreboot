...
struct rk3399_i2c_regs *i2c_bus[] = {
	(struct rk3399_i2c_regs *)I2C0_BASE,
	(struct rk3399_i2c_regs *)I2C1_BASE,
	(struct rk3399_i2c_regs *)I2C2_BASE,
	(struct rk3399_i2c_regs *)I2C3_BASE,
	(struct rk3399_i2c_regs *)I2C4_BASE,
	(struct rk3399_i2c_regs *)I2C5_BASE,
	(struct rk3399_i2c_regs *)I2C6_BASE,
	(struct rk3399_i2c_regs *)I2C7_BASE,
	(struct rk3399_i2c_regs *)I2C8_BASE,
};
...
static int i2c_send_start(struct rk3399_i2c_regs *reg_addr)
{
	int res = 0;
...
static int i2c_send_stop(struct rk3399_i2c_regs *reg_addr)
{
	int res = 0;
	int timeout = I2C_TIMEOUT_US;
...
static int i2c_read(struct rk3399_i2c_regs *reg_addr, struct i2c_seg segment)
{
	int res = 0;
	uint8_t *data = segment.buf;
	int timeout;
	unsigned int bytes_remaining = segment.len;
	unsigned int bytes_transfered;
...
static int i2c_write(struct rk3399_i2c_regs *reg_addr, struct i2c_seg segment)
{
	int res = 0;
	uint8_t *data = segment.buf;
	int timeout;
...
int platform_i2c_transfer(unsigned bus, struct i2c_seg *segments, int seg_count)
{
	int i;
	int res = 0;
	struct rk3399_i2c_regs *regs = i2c_bus[bus];
...
void i2c_init(unsigned int bus, unsigned int hz)
{
	...
	unsigned int divl;
	unsigned int divh;
	unsigned int i2c_src_clk = 198 * 1000 * 1000;
	struct rk3399_i2c_regs *regs = i2c_bus[bus];

	rkclk_configure_i2c(bus, i2c_src_clk);
