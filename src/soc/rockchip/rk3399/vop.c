...
static struct rk3399_vop_regs * const vop_regs[] = {
	(struct rk3399_vop_regs *)0xff900000,//VOP_LIT_BASE,
	(struct rk3399_vop_regs *)0xff8f0000 //VOP_BIG_BASE
};
...
void rkvop_enable(u32 vop_id, u32 fbbase, const struct edid *edid)
{
	...
	u32 xpos = 0, ypos = 0;
	struct rk3399_vop_regs *preg = vop_regs[vop_id];
